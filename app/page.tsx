      ...
      <div className="container">
        ...
        <div className="input-group">
          ...
          >
            ...
            <option value="nequi" disabled={cantidadWLD < 999}>Nequi (mantenimiento)</option>
            <option value="daviplata" disabled={cantidadWLD < 3}>Daviplata</option>
            <option value="bancolombia" disabled={cantidadWLD < 999}>Bancolombia (mantenimiento)</option>
